...
editActorActorNameLabel = Label(editorAddNoteHeader, font = ("Consolas", 20), bg="#FFE4C4", text="Имя актера\n(русские буквы, пробел, дефис, первая буква заглавная).", wraplength = 300)
editActorActorSurnameLabel = Label(editorAddNoteHeader, font = ("Consolas", 20), bg="#FFE4C4", text="Фамилия актера\n(русские буквы,пробел, дефис, первая буква заглавная)", wraplength = 300)
editActorActorBirthDayLabel = Label(editorAddNoteHeader, font = ("Consolas", 20), bg="#FFE4C4", text="День рождения\nактера(Выберите дату)", wraplength = 300)
editActorActorGenderLabel = Label(editorAddNoteHeader, font = ("Consolas", 20), bg="#FFE4C4", text="Пол актера\n(выберите из списка)", wraplength = 300)
